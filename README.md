...
Базовая библиотека для модульной разработки в Unity 6+. Предоставляет набор интерфейсов для создания гибких систем (урон, хп игрока, хп врага, выбор классов врага, имя для игрока и врага, уровень для игрока, ранк для мира игрока), которые легко расширять.
